...
public class ErasedOpenHashMap<K, V>
{
...
//    private final EntrySet<V> entrySet = new EntrySet<>();
     ...
     */
    public ErasedOpenHashMap(final int initialCapacity, final double loadFactor)
    {
...
//            if (null == values[index])
    ...
    */
    ...
    {
        ErasedOpenHashMap<Integer, Integer> m = new ErasedOpenHashMap<>();
